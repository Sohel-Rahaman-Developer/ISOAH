    ...
    <footer className="overflow-hidden">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          {/* Grid Sections */}
          <div className="mt-8 grid grid-cols-2 gap-3 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            {/* Newsletter Section */}
            <motion.div
            ...
            >
              <div>
                <h2 className="text-2xl font-bold text-[#ddd]">
                  Get the latest news!
                </h2>

                <p className="mt-4 text-gray-400">
                 Stay informed with the latest updates from ForensicsHQ.
                </p>
              </div>
            </motion.div>
            ...
            >
              <form className="w-full">
                ...
                <div className="border border-gray-100 p-2 h-full focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <input
                    type="email"
                    id="UserEmail"
                  ...
                  <button className="mt-1 rounded-md w-full bg-blue-600 px-6 py-3 text-sm font-bold uppercase tracking-wide text-[#ddd] transition-none hover:bg-blue-600 sm:mt-0 sm:w-auto sm:shrink-0">
                    Sign Up
                  </button>
                </div>
              </form>
            ...
            <motion.div
              ...
              transition={{ duration: 1 }}
            >
              <p className="font-medium text-[#ddd]">Our Links</p>
                ...
                <ul className="space-y-6 text-sm">
                  <li className="border-b border-gray-700 text-gray-400 pb-4">
                    <p className="text-md text-blue-400">
                      Branch - ISOEH Bhubaneswar
                    </p>

                    <p>
                      Our address is Plot Number 23, 2nd Floor, Lane Number 2,
                      District Center, Chandrasekharpur, Bhubaneswar, Odisha
                      751016.
                    </p>
                  </li>
                  <li className="border-b border-gray-700 text-gray-400 pb-4">
                    <p className="text-md text-blue-400">
                      Branch - ISOEH Siliguri
                    </p>
                    <p>
                      Our address is Baghajatin Park Main Road, Sub-Registry
                      Office Building, 1st Floor. Beside Axis Bank.
                    </p>
                  </li>
                  <li className="border-b border-gray-700 text-gray-400 pb-4">
                    <p className="text-md text-blue-400">Branch - ISOEH USA</p>
                    <p>
                      Our address is Woodbridge Corporate Plaza Building-C,
                      Suite 350, 485C US 1 South Iselin, New Jersey 08830 The
            ...
            <motion.div
              className="col-span-2 sm:col-span-1 lg:col-span-2 md:ps-3"
              variants={fadeInFromLeft}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
            ...
            >
              <div className="flex flex-col items-center lg:items-start">
                ...
                ></motion.iframe>
                <div className="mt-4">
                  <p className="text-md text-gray-400">ForensicsHQ</p>
                  <p className="text-sm font-medium text-gray-400"></p>
                  <p className="text-sm text-gray-400">
                    Kariwala Tower , J1-5, EP Block, Salt Lake City,<br></br>{" "}
                    Kolkata – 700091
                  </p>
